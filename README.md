...
The 3D game renders the same world everywhere, but varies by platform how much of the per-level stack is drawn and lit at any moment in order to maximise performance on platforms where it is needed.  

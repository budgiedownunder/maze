...
- Validation tests
- The contract suite against FileStore (`tests/file_store_contract.rs` — 136 scenarios)
- The contract suite against SqlStore over in-memory SQLite (`tests/sql_store_contract.rs` — 136 scenarios)
- Doc tests

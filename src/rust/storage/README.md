...
The SqlStore schema is defined across the migration files in [`migrations/`](./migrations/) plus the per-backend blob tables created in `SqlStore::new`. It creates sixteen tables:

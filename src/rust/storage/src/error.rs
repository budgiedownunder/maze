...
pub enum Error {
    ...
    UserNotFound(),
    UserPasswordMissing(),
    TokenIdExists(String),
    TokenIdNotFound(String),
    TokenAlreadyConsumed(),
    TokenExpired(),
    AuditEntryIdExists(String),
    AuditEntryIdNotFound(String),
    MazeError(MazeError),
    MazeIdMissing(),
...
impl std::fmt::Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Error::TokenIdExists(id) => write!(f, "A token with id '{id}' already exists"),
            Error::TokenIdNotFound(id) => write!(f, "A token with id '{id}' was not found"),
            Error::TokenAlreadyConsumed() => write!(f, "The token has already been consumed"),
            Error::TokenExpired() => write!(f, "The token has expired"),
            Error::AuditEntryIdExists(id) => write!(f, "An audit entry with id '{id}' already exists"),
            Error::AuditEntryIdNotFound(id) => write!(f, "An audit entry with id '{id}' was not found"),

    ...
    cfg
        ...
        .service(
            web::scope("")
                ...
                .service(game_definitions::grant_game_definition_share)
                .service(game_definitions::revoke_game_definition_share)
                ...
                .service(game_collections::reorder_game_collection_items)
                .service(game_collections::add_game_collection_item)
                .service(game_collections::remove_game_collection_item)
                .service(game_collections::list_game_collection_shares)
                .service(game_collections::grant_game_collection_share)
                .service(game_collections::revoke_game_collection_share)

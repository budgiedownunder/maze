...
const TILES = [
  ...
  { to: '/play-3d/my-games', img: '/images/workshop/workshop-game.svg', title: 'My Games', desc: 'Your own 3D games and collections' },
  { to: '/play-3d/shared', img: '/images/workshop/workshop-game-collections.svg', title: 'Shared with me', desc: 'Games and collections others have shared with you' },
  { to: '/play-3d/community', img: '/images/workshop/workshop-games.svg', title: 'Community', desc: 'Public games and collections from everyone' },
] as const

...
- Reading and writing per-cell override characteristics for an enemy (type / damage / move interval), a health pickup (style / heal amount), treasure (style / value), a key holder, a door style, or a wall type (a solid texture or a water / lava / iron-fence skin)

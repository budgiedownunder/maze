    ...
    class MazeWasmerConnector : MazeWebAssemblyConnectorBase, IMazeConnector
    {
        ...
        private void InitializeFunctionMap()
        {
            _functionMap = new Dictionary<string, RefFunctionGetter>
            {
                ...
                { "maze_wasm_get_cell_entity", () => ref this.mazeGetCellEntity },
                { "maze_wasm_set_cell_entity", () => ref this.mazeSetCellEntity },
                { "maze_wasm_clear_cell_entity", () => ref this.mazeClearCellEntity },
                ...
                { "maze_game_wasm_is_lost",          () => ref this.mazeGameIsLost },
                { "maze_game_wasm_lose_reason",      () => ref this.mazeGameLoseReason },
                ...
                { "maze_game_wasm_get_tick_event_payload", () => ref this.mazeGameGetTickEventPayload },
                { "maze_game_wasm_key_count",        () => ref this.mazeGameKeyCount },
                { "maze_game_wasm_get_key",          () => ref this.mazeGameGetKey },
                { "maze_game_wasm_hp",               () => ref this.mazeGameHp },
                { "maze_game_wasm_max_hp",           () => ref this.mazeGameMaxHp },
                { "maze_game_wasm_enemy_count",      () => ref this.mazeGameEnemyCount },
